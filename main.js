...
┊🌎 NaufraZapp-MD ✦ WhatsApp Bot 🌎
╰${lineM}╯
${chalk.greenBright('╭⋇⊰ ⌑┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉⌑ ⊱⋇╮')}
${chalk.greenBright('┊')} ${chalk.cyanBright('╔═══════════════⋄')}
${chalk.greenBright('┊')} ${chalk.cyanBright('║')} ${chalk.green.bgGreen.bold.white(mid.methodCode1)}
${chalk.greenBright('┊')} ${chalk.cyanBright('╚═══════════════⋄')}   
${chalk.greenBright('┊')} ${chalk.whiteBright('╔═══════════════⋄')}     
${chalk.greenBright('┊')} ${chalk.whiteBright('║')} ${chalk.green.bgGreen.bold.white(mid.methodCode2)}
${chalk.greenBright('┊')} ${chalk.whiteBright('║')} ${chalk.bold.greenBright(`➭ ${mid.methodCode3} 1:`)} ${chalk.whiteBright(mid.methodCode4)}
${chalk.greenBright('┊')} ${chalk.whiteBright('║')} ${chalk.bold.greenBright(`➭ ${mid.methodCode3} 2:`)} ${chalk.whiteBright(mid.methodCode5)}
${chalk.greenBright('┊')} ${chalk.whiteBright('╚═══════════════⋄')}
${chalk.greenBright('┊')} ${chalk.cyanBright('╔═══════════════⋄')}     
${chalk.greenBright('┊')} ${chalk.cyanBright('║')} ${chalk.italic.white(mid.methodCode6)}
${chalk.greenBright('┊')} ${chalk.cyanBright('║')} ${chalk.italic.white(mid.methodCode7)}
${chalk.greenBright('┊')} ${chalk.cyanBright('╚═══════════════⋄')} 
${chalk.greenBright('╰⋇⊰ ⌑┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉⌑ ⊱⋇╯')}
${chalk.greenBright(`╭${lineM}╮`)}
${chalk.greenBright('┊🌎 NaufraZapp-MD ✦ Version Bot ${vs} 🌎')}
