...
conn.reply(m.chat, `${lenguajeGB['smsAvisoIIG']()}${mid.smsinfo}`, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: 'Historias de Instagram', body: 'Descargador...',          previewType: 0, thumbnail: gataMenu, sourceUrl: md}}})
}} catch (e) {
